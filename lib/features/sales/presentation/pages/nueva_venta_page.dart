...
class _NuevaVentaPageState extends State<NuevaVentaPage> with SingleTickerProviderStateMixin {
    ...
    if (mounted) {
      if (success) {
        ...
        final result = await Navigator.push<String>(
          context,
          MaterialPageRoute(
            builder: (context) => VentaExitosaPage(
              clienteNombre: widget.cliente.nombreCliente,
              total: totalAmount,
              ventaId: ventaId,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                TextButton(
                  onPressed: () => Navigator.pop(context),
                  child: const Text('Cambiar', style: TextStyle(color: AppTheme.accentColor, fontWeight: FontWeight.bold)),
                ),
              ],
            ),
          ),
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                    ...
                    Expanded(
                      child: _isLoading
                          ...
                          : filteredProducts.isEmpty
                              ? const Center(child: Text('No hay productos disponibles.', style: TextStyle(color: AppTheme.textSecondary)))
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: hasQty ? const Color(0xFFFFF9F2) : Colors.white,
                                        borderRadius: BorderRadius.circular(16),
                                        border: Border.all(
                                          color: hasQty ? const Color(0xFFFFE0B2) : AppTheme.lightGrey,
                                        ...
                                        children: [
                                          ...
                                          if (!hasQty)
                                            ...
                                            Row(
                                              children: [
                                                GestureDetector(
                                                  onTap: () => _removeFromCart(p.articuloId),
                                                  child: Container(
                                                    width: 36,
                                                    height: 36,
                                                    decoration: const BoxDecoration(
                ...
                _cart.isEmpty
                    ? const Center(child: Text('El carrito está vacío.', style: TextStyle(color: AppTheme.textSecondary)))
                    : Column(
                        children: [
                          Expanded(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              prod.nombre.length > 15 ? '${prod.nombre.substring(0, 12)}...' : prod.nombre,
                                              style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: AppTheme.textPrimary),
                                            ),
                                            const SizedBox(height: 4),
                                            Text(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: const TextStyle(color: Color(0xFFFFB74D), fontWeight: FontWeight.bold, fontSize: 20),
                                ),
                              ],
                            ),
                          ),
